...
pub struct Computer {
    ...
    is_halted: bool,
    initial_program: HashMap<isize, isize>,
}

impl Computer {
    pub fn init(program: &str, input: Vec<isize>) -> Computer {
        ...
        Computer {
            ...
            output: Vec::new(),
            is_halted: false,
            initial_program: instructions.clone(),
        }
    }
    ...
    pub fn get_output(&mut self) -> Vec<isize> {
        self.output.clone()
    }
